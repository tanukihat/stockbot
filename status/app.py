...
.tbl-wrap td{padding:10px 14px;font-family:var(--mono);font-size:12px;border-bottom:1px solid var(--border);white-space:nowrap;}
...
.mob-cell-val{font-family:var(--mono);font-size:12px;margin-top:1px;}
